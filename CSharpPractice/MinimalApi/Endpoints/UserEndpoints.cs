...
internal static class UserEndpoints
{
    ...
    public static IEndpointRouteBuilder MapUserEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        ///api/users/data
        group.MapGet("data", (UserService userService) =>
        {
        ...
        group.MapGet("/{id:guid}", (Guid id, [FromServices] UserService userService) =>
        {
        ...
        group.MapPut("/{id:guid}", (UserRequest request, UserService userService, Guid id) =>
        {
